...
export const GET: APIRoute = async ({ site }) => {
  ...
  const staticPages = [
    ...
    { url: 'services/technical-seo-audits', priority: '0.9', changefreq: 'weekly' },
    { url: 'services/on-page-seo', priority: '0.9', changefreq: 'weekly' },
    { url: 'services/content-marketing', priority: '0.9', changefreq: 'weekly' },
    { url: 'services/website-redesign', priority: '0.9', changefreq: 'weekly' },
    ...
    { url: 'industries/restaurants', priority: '0.85', changefreq: 'monthly' },
    { url: 'industries/legal', priority: '0.85', changefreq: 'monthly' },
    { url: 'industries/contractors/irvine', priority: '0.8', changefreq: 'monthly' },
    { url: 'industries/contractors/fullerton', priority: '0.8', changefreq: 'monthly' },
    { url: 'industries/contractors/anaheim', priority: '0.8', changefreq: 'monthly' },
    { url: 'industries/contractors/huntington-beach', priority: '0.8', changefreq: 'monthly' },
    { url: 'industries/contractors/lake-forest', priority: '0.8', changefreq: 'monthly' },
    { url: 'industries/contractors/newport-beach', priority: '0.8', changefreq: 'monthly' },
    { url: 'industries/contractors/costa-mesa', priority: '0.8', changefreq: 'monthly' },
    { url: 'industries/contractors/santa-ana', priority: '0.8', changefreq: 'monthly' },
    { url: 'industries/dental/irvine', priority: '0.8', changefreq: 'monthly' },
    { url: 'industries/dental/fullerton', priority: '0.8', changefreq: 'monthly' },
    { url: 'industries/dental/anaheim', priority: '0.8', changefreq: 'monthly' },
    { url: 'industries/dental/huntington-beach', priority: '0.8', changefreq: 'monthly' },
    { url: 'industries/dental/lake-forest', priority: '0.8', changefreq: 'monthly' },
    { url: 'industries/dental/newport-beach', priority: '0.8', changefreq: 'monthly' },
    { url: 'industries/dental/costa-mesa', priority: '0.8', changefreq: 'monthly' },
    { url: 'industries/dental/santa-ana', priority: '0.8', changefreq: 'monthly' },
