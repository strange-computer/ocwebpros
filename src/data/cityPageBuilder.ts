...
export function buildLocalSeoPage(city: CityRegistryEntry): CityServicePageData {
  ...
  return {
    ...
    badge: city.badge,
    title: `SEO Services in ${city.name}, CA | Local SEO Agency | OCWebPros`,
    description: `Looking for SEO in ${city.name}? OCWebPros provides local SEO services for ${city.name} businesses — Google Business Profile, Maps rankings, city landing pages, and citations. Free audit. Lake Forest-based agency.`,
    heroSubtitle: `Hire a local SEO team for ${city.name} — Google Maps, Business Profile, and city pages built to bring in customers ready to call.`,
    intro: [
      `If you searched for SEO in ${city.name} or local SEO ${city.name}, this is the page to hire from. We help ${city.name} businesses rank in Google Search and Maps with dedicated city pages, active Google Business Profiles, and consistent review signals — not generic Orange County tactics.`,
